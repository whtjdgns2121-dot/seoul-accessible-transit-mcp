"""
서울대중교통(교통약자편) — 교통약자 전용 대중교통 MCP 서버
...
async def check_station_facilities(station: str) -> str:
    ...
    서울대중교통(교통약자편) transit service. Use this to warn a mobility-impaired user when
...
async def get_low_floor_bus_arrival(stop_name: str) -> str:
    ...
    Seoul bus stop, using the 서울대중교통(교통약자편) transit service. Filters out regular
...
async def verify_route_accessibility(stations: list[str], mobility_type: str = "wheelchair") -> str:
    ...
    mobility-impaired user, using the 서울대중교통(교통약자편) transit service.
...
async def get_service_alerts(line: str = "") -> str:
    ...
    서울대중교통(교통약자편) transit service. Optionally filter by line name
...
async def find_call_taxi(region: str = "서울") -> str:
    ...
    서울대중교통(교통약자편) transit service. Input: region name (default '서울')."""
